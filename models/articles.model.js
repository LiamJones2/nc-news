...
exports.returnArticle = (article_id) => {
    ...
    return db.query('SELECT articles.*, COUNT(comments.comment_id) as comment_count FROM articles LEFT JOIN comments ON comments.article_id = $1 GROUP BY articles.article_id', [article_id]).then(({ rows }) => {
